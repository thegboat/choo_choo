...
void init_care_cloud_edi_835(){
  ...
  cISA = rb_define_class_under(mEDI835, "ISA", cSegment);
  cBPR = rb_define_class_under(mEDI835, "BPR", cSegment);
  cTRN = rb_define_class_under(mEDI835, "TRN", cSegment);
  cCUR = rb_define_class_under(mEDI835, "CUR", cSegment);
  cDTM = rb_define_class_under(mEDI835, "DTM", cSegment);
  cPER = rb_define_class_under(mEDI835, "PER", cSegment);
  cMIA = rb_define_class_under(mEDI835, "MIA", cSegment);
  cREF = rb_define_class_under(mEDI835, "REF", cSegment);
  cCAS = rb_define_class_under(mEDI835, "CAS", cSegment);
  cIEA = rb_define_class_under(mEDI835, "IEA", cSegment);
  cQTY = rb_define_class_under(mEDI835, "QTY", cSegment);
  cSVC = rb_define_class_under(mEDI835, "SVC", cSegment);
  cCLP = rb_define_class_under(mEDI835, "CLP", cSegment);
  cPLB = rb_define_class_under(mEDI835, "PLB", cSegment);
  cTS3 = rb_define_class_under(mEDI835, "TS3", cSegment);
  cTS2 = rb_define_class_under(mEDI835, "TS2", cSegment);
  cMOA = rb_define_class_under(mEDI835, "MOA", cSegment);
  cRDM = rb_define_class_under(mEDI835, "RDM", cSegment);
  cLX = rb_define_class_under(mEDI835, "LX", cSegment);
  cLQ = rb_define_class_under(mEDI835, "LQ", cSegment);
  cN1 = rb_define_class_under(mEDI835, "N1", cSegment);
  cN3 = rb_define_class_under(mEDI835, "N3", cSegment);
  cN4 = rb_define_class_under(mEDI835, "N4", cSegment);
  cGS = rb_define_class_under(mEDI835, "GS", cSegment);
  cST = rb_define_class_under(mEDI835, "ST", cSegment);
  cGE = rb_define_class_under(mEDI835, "GE", cSegment);
  cSE = rb_define_class_under(mEDI835, "SE", cSegment);
  cNM1 = rb_define_class_under(mEDI835, "NM1", cSegment);
  cAMT = rb_define_class_under(mEDI835, "AMT", cSegment);
